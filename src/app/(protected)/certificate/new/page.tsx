...
export default function CertificateNewPage() {
  ...
  const { createCertificate, loadingAction } = useCertificates();
  const { skills: allSkills, loading } = useSkills(); // Assuming this hook exists
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newCertificate = await createCertificate(
        formData,
        { pdf: pdfFile || undefined, image: imageFile || undefined }
      );
